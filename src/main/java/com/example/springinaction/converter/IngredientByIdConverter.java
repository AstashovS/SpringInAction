...
public class IngredientByIdConverter implements Converter<String, Ingredient> {
    ...
    public IngredientByIdConverter() {
        ...
        ingredientMap.put("GRBF", new Ingredient("GRBF", "Flour Tortilla", Type.PROTEIN));
        ingredientMap.put("CARN", new Ingredient("CARN", "Flour Tortilla", Type.PROTEIN));
        ingredientMap.put("TMTO", new Ingredient("TMTO", "Flour Tortilla", Type.VEGGIES));
